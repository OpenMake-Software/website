...
You can now edit your local versions of the site's source files. To preview your site, go to your site root directory and run `hugo server`. By default, your site will be available at https://localhost:1313/. To push changes to your new repo, go to your site root directory and use `git push`.-->
...
1. Preview your site in your browser at: https://localhost:1313/. You can use `Ctrl + c` to stop the Hugo server whenever you like.
...
By default, your site will be available at https://localhost:1313/.
